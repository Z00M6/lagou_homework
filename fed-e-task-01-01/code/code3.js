...
// 2.实现 ex1 函数·
function ex1(arr) {
  return fp.map((item) =>{ return item + 1} ,arr)
}
// const ex1 = (arr) => {fp.map((item) =>{return item++} ,arr)}
// 3.调用测试
console.log( maybe.map(ex1),'ex1')  // Maybe { _value: [ 6, 7, 2 ] }
